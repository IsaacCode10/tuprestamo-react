              ...
              {disbursements.map((d) => (
                ...
                <td style={{ padding: 8, borderBottom: '1px solid #f3f3f3', display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
                  ...
                  <button
                    ...
                    title="Requiere contrato notariado. Luego sube el comprobante del pago al banco y pulsa aqu�. Generaremos el contrato autom�tico y notificaremos al prestatario e inversionistas."
                  >
                    Registrar pago dirigido
                  </button>
                  <span
                    title="Sube el comprobante del pago al banco antes de registrar. El contrato se genera autom�tico y se notifican prestatario e inversionistas."
                    style={{
                      display: 'inline-flex',
                      alignItems: 'center',
