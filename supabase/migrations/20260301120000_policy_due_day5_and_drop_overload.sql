-- Política operativa de fechas (MVP):
-- - Primera cuota: día 5 del mes siguiente al desembolso dirigido.
-- - Siguientes cuotas: día 5 de cada mes.
-- Además, eliminar overload residual que genera ambigüedad.
...
drop function if exists public.registrar_pago_dirigido(bigint, text, jsonb);
