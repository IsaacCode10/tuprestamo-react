-- Fix: en el loop de distribucion no usar inversiones%rowtype.
-- El select parcial (investor_id, amount) contra rowtype puede mapear por posicion
-- y forzar cast UUID->bigint (id), causando:
